...
const swagger_config_service_1 = require("./swagger-config.service");
let SwaggerModule = class SwaggerModule {
};
exports.SwaggerModule = SwaggerModule;
exports.SwaggerModule = SwaggerModule = __decorate([
    (0, common_1.Module)({
        providers: [swagger_config_service_1.SwaggerConfigService],
        exports: [swagger_config_service_1.SwaggerConfigService],
    })
], SwaggerModule);
